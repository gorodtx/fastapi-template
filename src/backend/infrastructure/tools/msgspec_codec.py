...
class MsgspecDTOCodec(DTOCodec):
    def to_mapping(
        ...
        *,
        ...
        if _is_mapping(builtins):
            return _normalize_mapping(builtins, exclude_none=exclude_none, exclude=ex)
    ...
    def to_string(
        ...
        *,
        ...
        if exclude_none or exclude:
            return msgspec_encoder(self.to_mapping(obj, exclude_none=exclude_none, exclude=exclude))
    ...
    def to_bytes(
        ...
        *,
        ...
        if exclude_none or exclude:
            return msgpack_encoder(self.to_mapping(obj, exclude_none=exclude_none, exclude=exclude))
