...
class LoginType(TypeDecorator[Login]):
    ...
    def process_bind_param(self, value: Login | None, dialect: Dialect) -> str | None:
        del dialect
        return bind_vo(value, Login)

    def process_result_value(self, value: str | None, dialect: Dialect) -> Login | None:
        del dialect
...
class UsernameType(TypeDecorator[Username]):
    ...
    def process_bind_param(self, value: Username | None, dialect: Dialect) -> str | None:
        del dialect
